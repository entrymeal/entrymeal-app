...
export default {
  ...
  footerDefaultBg: platform === "ios" ? "#fff" : "#3F51B5",
  ...
  toolbarDefaultBorder: platform === "ios" ? "#fff" : "#3F51B5",
  get statusBarColor() {
  ...
  // Segment
  segmentBackgroundColor: platform === "ios" ? "#fff" : "#3F51B5",
